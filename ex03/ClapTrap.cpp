...
ClapTrap::ClapTrap(void) {
	std::cout << "default ClavTrap constructor is called" << std::endl;
}
...
ClapTrap::ClapTrap(const std::string &name, unsigned int hitpoints) : name(name), hitpoints(hitpoints), energy(50), attack_damage(20) {
	std::cout << "ClapTrap " << name << " with " << this->hitpoints << " hitpoints, ";
	std::cout << this->energy << " energy_points and " << this->attack_damage;
	std::cout << " attack damage is created" << std::endl;
}

ClapTrap::ClapTrap(const std::string &name, unsigned int hitpoints, unsigned int energy) : name(name), hitpoints(hitpoints), energy(energy), attack_damage(30) {
	std::cout << "ClapTrap " << name << " with " << this->hitpoints << " hitpoints, ";
	std::cout << this->energy << " energy_points and " << this->attack_damage;
	std::cout << " attack damage is created" << std::endl;
}
